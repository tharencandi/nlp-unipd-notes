...
The resolution of word embeddings cannot not capture all relevant meaning when words are structured in sentences, phrases, paragraphs, whole documents. 
...
However - the meaning of a sentence is a *non-trivial* combination of the meaning of words, dependant on **order**. This representation cannot capture this meaning.
...
- This pushes together semenatically related examples through the process of allignment
...
#### Supervised approach
 1. Wieting et al. “Towards Universal Paraphrastic Sentence Embeddings”
	...
	- use contradicting snetence as hard negatives (to push apart)
...
- obtain positive pairs by passing input sentence to pre-trained encoder twice with independantly sampeld dropout masks
...
- use paragprah matrices, with an averaging or concatentation proceess, for final classificiation. 
- another approach
