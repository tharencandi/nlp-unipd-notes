...
- choice of Y(x) and scoring function determines the effectiveness and efficiency of the algorithm

#### Arc-factored Model

This is a general formulation that decomposes the scoring function to more manageable subproblems.
